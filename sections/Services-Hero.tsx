            ...
            <div className="bg-brand-20 bg-opacity-70 relative">
                <div className="container md:flex items-center gap-8 pt-20 pb-8">
                    <div className="py-16 md:w-2/3 m-auto md:text-center">
                        ...
                        <div className="mt-8 m-auto"><Link href="/contact-us" className="inline-flex justify-center py-3 px-6 bg-accent-600 text-sm font-semibold text-white rounded-lg hover:bg-accent-700">Contact Us Now
