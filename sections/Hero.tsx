...
const Hero = () => {
    return <section className="border-b border-slate-100 overflow-hidden">
        ...
        <div className="bg-brand-20 bg-opacity-60 relative pt-[84px]">
            <div className="container md:flex items-center gap-8 pt-12 md:pt-20 pb-8">
                <div className="py-10 md:py-16 md:w-1/2">
                    <h1 className="font-semibold text-brand-600">Software Development Company</h1>
                    <p className="font-extrabold text-3xl md:text-5xl text-accent-600 tracking-tight md:leading-[3.5rem] mt-5">Transform your business with a digital solution.</p>
                ...
                <div className="md:py-16 md:w-1/2">
                    <div className="bg-white p-8 shadow-2xl shadow-slate-900/10 rounded-xl max-w-sm float-right w-full mb-16">
                        ...
                        <Link href="/contact-us" className="inline-flex justify-center py-3 px-6 bg-accent-600 text-sm font-semibold text-white rounded-lg hover:bg-accent-700 mt-6">Contact Us
                            <span className="opacity-75 ml-2">→</span></Link>
                    </div>
                </div>
            </div>
