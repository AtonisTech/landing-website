            ...
            <div className="container">
                ...
                <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16">
                    <div className="rounded-xl">
                        <div className="p-8 md:p-12 flex flex-col bg-gradient-to-r from-brand-30 to-brand-50 h-full rounded-xl bg-opacity-90 backdrop-filter backdrop-blur-2xl">
                    ...
                    <div className="rounded-xl">
                        <div className="p-8 md:p-12 flex flex-col bg-gradient-to-r from-brand-30 to-brand-50 h-full rounded-xl">
